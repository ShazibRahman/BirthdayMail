...
def retry(
    retries: int = 3, delay: float = 1, fail_after_exhausted_retry: bool = False
) -> Callable:
    """
    ...
    :param fail_after_exhausted_retry: bool:  (Default value = False) If True, the function will raise the exception after the retries are exhausted
